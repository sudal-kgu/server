...
public class AnalysisController {
    ...
    @Operation(
            summary = "분석 결과 선택 및 저장",
            description = "사용자가 선택한 쓰레기 객체들의 분석 결과를 DB에 저장합니다."
    )
    @PostMapping("/select")
    public ResponseEntity<BaseResponse<AnalysisSelectionDto>> confirmSelection(@RequestBody AnalysisRequestDto dto){
        return BaseResponse.success(analysisService.confirmSelection(dto));
    }
}